      ...
      '/vite-plugin-vue-routes': [
        {
          ...
          items: [
            ...
            { text: 'Guards (Middleware)', link: '/vite-plugin-vue-routes/middleware' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: 'Overview', link: '/vite-plugin-vue-routes/v0.9.13/' },
            { text: 'Routes', link: '/vite-plugin-vue-routes/v0.9.13/routes' },
            { text: 'Layouts', link: '/vite-plugin-vue-routes/v0.9.13/layouts' },
            { text: 'Middleware', link: '/vite-plugin-vue-routes/v0.9.13/middleware' },
            { text: 'Configuration', link: '/vite-plugin-vue-routes/v0.9.13//configuration' },
          ],
        },
      ],
