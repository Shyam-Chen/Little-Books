    ...
    sidebar: {
      ...
      '/vite-plugin-vue-routes': [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: 'Overview', link: '/vite-plugin-vue-routes-v0/' },
            { text: 'Routes', link: '/vite-plugin-vue-routes-v0/routes' },
            { text: 'Layouts', link: '/vite-plugin-vue-routes-v0/layouts' },
            { text: 'Middleware', link: '/vite-plugin-vue-routes-v0/middleware' },
            { text: 'Configuration', link: '/vite-plugin-vue-routes-v0//configuration' },
          ],
        },
      ],
